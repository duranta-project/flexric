...
`XAPP_DURATION` environment variable overwrites the default xApp duration of infinity (`INT_MAX`). If the negative value used, the xApp duration is also considered to be infinite.
